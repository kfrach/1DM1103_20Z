...
int main(int argc, char ** argv)
 {
    ...
    if (strcmp("list_students", argv[2]) == 0) {
        ...
        bazaS->lista_studentow = sortuj_studentow_przez_wybieranie(bazaS->lista_studentow); 
        listuj_studentow(bazaS);
    } else if (strcmp("sort_descending_name", argv[2]) == 0) {
        bazaP->lista_przedmiotow = sortuj_przedmioty_przez_wybieranie_nazwa(bazaP->lista_przedmiotow); 
        listuj_przedmioty(bazaP);
    } else if (strcmp("sort_descending_code", argv[2]) == 0) {
        bazaP->lista_przedmiotow = sortuj_przedmioty_przez_wybieranie_kod(bazaP->lista_przedmiotow); 
        listuj_przedmioty(bazaP);
    } 
